...
В ходе работы необходимо было выяснить, какие блоки оказывают наиболее положительное влияние в соответствии с целевым текстовым запросом, а какие наоборот или почти не влияют. Использовался датасет CIFAR-10 (https://www.cs.toronto.edu/~kriz/cifar.html)
